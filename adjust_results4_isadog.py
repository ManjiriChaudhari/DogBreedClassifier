...
def adjust_results4_isadog(results_dic, dogfile):
    ...
    # ---- STEP 2: Loop through results_dic and add dog indicators ----
    for filename in results_dic:
        ...
        # Classifier label may include multiple names separated by commas
        classifier_labels_list = [label.strip() for label in classifier_label.split(",")]

        # Check if ANY of the classifier labels match a dog name
        is_classifier_dog = 0
